...
object Speed {
  ...
  case object UltraBullet
      extends Speed(
        ...
        0 to 59,
        "UltraBullet",
        "Insanely fast games: less than 60 seconds",
      )
  case object Bullet
      extends Speed(1, "bullet", 60 to 299, "Bullet", "Very fast games: less than 5 minutes")
  ...
  def apply(clock: Option[Clock.Config]): Speed = byTime(
    clock.fold(Int.MaxValue)(_.estimateTotalSeconds),
  )
