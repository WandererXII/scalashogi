...
object KifUtils {
  ...
  private[kif] val toKifChushogi: Map[Role, NonEmptyList[String]] =
    Map(
      ...
      LionPromoted     -> NonEmptyList.of("獅子", "獅", "師"),
